...
export class DeleteCartBodyDTO extends createZodDto(RemoveCartItemBodySchema) {}

export class GetCartPaginationQueryDTO extends createZodDto(GetCartPaginationQuerySchema) {}
